...
func (m *MockDatabase) AncientBytes(arg0 string, arg1, arg2, arg3 uint64) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AncientBytes", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDatabaseMockRecorder) AncientBytes(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AncientBytes", reflect.TypeOf((*MockDatabase)(nil).AncientBytes), arg0, arg1, arg2, arg3)
}
