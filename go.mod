...
require (
	...
	github.com/0xPolygon/sequence-store-proto v0.0.0-00010101000000-000000000000
...
replace github.com/0xPolygon/sequence-store-proto => ./third_party/sequence-store-proto
