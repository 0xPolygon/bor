...
replace (
	...
	// TODO marcello update to final version once released
	github.com/0xPolygon/heimdall-v2 => github.com/0xPolygon/heimdall-v2 v0.6.1-0.20260403074111-60332eecc876
