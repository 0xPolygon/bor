...
type Config struct {
	...
	TargetGasMin           uint64 // Minimum target gas percentage (1-100) when dynamic target gas is enabled
	TargetGasMax           uint64 // Maximum target gas percentage (1-100) when dynamic target gas is enabled
