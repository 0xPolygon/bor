...
- ```preconfs.bp-rpc-endpoints```: Comma separated rpc endpoints of all block producers

- ```preconfs.enable```: Enable transaction pre-confirmations via block producers (default: false)
