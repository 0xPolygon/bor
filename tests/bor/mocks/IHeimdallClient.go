...
import (
	...
	heimdallws "github.com/ethereum/go-ethereum/consensus/bor/heimdallws"
...
// Close mocks base method.
func (m *MockIHeimdallWSClient) Close() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Close")
}
...
// SubscribeSpanEvents mocks base method.
func (m *MockIHeimdallWSClient) SubscribeSpanEvents(ctx context.Context) <-chan *span.HeimdallSpanEvent {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeSpanEvents", ctx)
	ret0, _ := ret[0].(<-chan *span.HeimdallSpanEvent)
	return ret0
}

// SubscribeSpanEvents indicates an expected call of SubscribeSpanEvents.
func (mr *MockIHeimdallWSClientMockRecorder) SubscribeSpanEvents(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeSpanEvents", reflect.TypeOf((*MockIHeimdallWSClient)(nil).SubscribeSpanEvents), ctx)
}

// Unsubscribe mocks base method.
func (m *MockIHeimdallWSClient) Unsubscribe(eventType heimdallws.HeimdallEvent) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Unsubscribe", eventType)
}

// Unsubscribe indicates an expected call of Unsubscribe.
func (mr *MockIHeimdallWSClientMockRecorder) Unsubscribe(eventType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Unsubscribe", reflect.TypeOf((*MockIHeimdallWSClient)(nil).Unsubscribe), eventType)
}
