...
func (m *MockIHeimdallClient) FetchStatus(ctx context.Context) (*types0.SyncInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchStatus", ctx)
	ret0, _ := ret[0].(*types0.SyncInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FetchStatus indicates an expected call of FetchStatus.
func (mr *MockIHeimdallClientMockRecorder) FetchStatus(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
