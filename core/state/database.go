...
func (db *CachingDB) OpenTrie(root common.Hash) (Trie, error) {
	...
	tr, err := trie.NewParallelSparseTrie(trie.StateTrieID(root), db.triedb)
	if err != nil {
		return nil, err
	}
...
func (db *CachingDB) OpenStorageTrie(stateRoot common.Hash, address common.Address, root common.Hash, self Trie) (Trie, error) {
	...
	tr, err := trie.NewParallelSparseTrie(trie.StorageTrieID(stateRoot, crypto.Keccak256Hash(address.Bytes()), root), db.triedb)
	if err != nil {
		return nil, err
	}
