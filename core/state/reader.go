...
// newTrieReaderWithSnapshot mirrors newMPTTrieReader but receives a snapshot-aware
...
// readers must use newMPTTrieReader.
func newTrieReaderWithSnapshot(root common.Hash, db *triedb.Database, nodeDB database.NodeDatabase) (*mptTrieReader, error) {
	if db.IsUBT() {
