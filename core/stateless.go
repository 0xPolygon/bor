...
func ExecuteStateless(config *params.ChainConfig, vmconfig vm.Config, block *types.Block, witness *stateless.Witness, author *common.Address, consensus consensus.Engine, diskdb ethdb.Database) (common.Hash, common.Hash, *state.StateDB, uint64, error) {
	...
	if err != nil {
		return common.Hash{}, common.Hash{}, nil, 0, err
	}
	...
	return stateRoot, receiptRoot, db, res.GasUsed, nil
}
