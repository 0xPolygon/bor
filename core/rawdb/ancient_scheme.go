...
const (
	// ChainFreezerBlockDataGroup is the tail group shared by the body, receipt,
	// total difficulty and bor receipt tables. They are pruned together and
	// therefore have the same tail position.
