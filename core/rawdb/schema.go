...
var (
	...
	CompactWitnessPrefix     = []byte("compactWitness-")     // Compact witness with cached nodes removed (WIT1)
	CompactWitnessSizePrefix = []byte("compactWitnessSize-") // Size of compact witness
