...
var fuzzCreateSnippets = [][]byte{
	...
	// 3: runtime code exercising the journal/revert, committed-state gas,
	// transient storage, SELFBALANCE and EXTCODEHASH paths:
	//   if CALLDATASIZE > 0: slot4 = 99; REVERT   (reached via the self-CALL)
	//   slot2 = SLOAD(2)+1; TSTORE(0,7); slot3 = TLOAD(0);
	//   CALL self with 1 byte calldata (reverts, must roll back slot4);
	//   slot5 = SELFBALANCE; slot6 = EXTCODEHASH(self); slot3 = 0 (refund); STOP
	{0x60, 0x40, 0x60, 0x0c, 0x60, 0x00, 0x39, 0x60, 0x40, 0x60, 0x00, 0xf3, 0x36, 0x60, 0x35, 0x57, 0x60, 0x02, 0x54, 0x60, 0x01, 0x01, 0x60, 0x02, 0x55, 0x60, 0x07, 0x60, 0x00, 0x5d, 0x60, 0x00, 0x5c, 0x60, 0x03, 0x55, 0x60, 0x00, 0x60, 0x00, 0x60, 0x01, 0x60, 0x00, 0x60, 0x00, 0x30, 0x5a, 0xf1, 0x50, 0x47, 0x60, 0x05, 0x55, 0x30, 0x3f, 0x60, 0x06, 0x55, 0x60, 0x00, 0x60, 0x03, 0x55, 0x00, 0x5b, 0x60, 0x63, 0x60, 0x04, 0x55, 0x60, 0x00, 0x60, 0x00, 0xfd},
}
