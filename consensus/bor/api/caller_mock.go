...
//
//	mockgen -destination=./caller_mock.go -package=api . Caller
//
...
func (mr *MockCallerMockRecorder) Call(ctx, args, blockNrOrHash, overrides, blockOverrides any) *gomock.Call {
...
func (mr *MockCallerMockRecorder) CallWithState(ctx, args, blockNrOrHash, state, overrides, blockOverrides any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCallerMockRecorder) GetBalance(ctx, address, blockNrOrHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
