...
var (
	...
	rABI, _ = abi.JSON(strings.NewReader(reservedRegistryABI))
)
...
func ReservedBlockspaceRegistry() abi.ABI {
	return rABI
}
...
func NewGenesisContractsClient(
	...
	return &GenesisContractsClient{
		...
		reservedRegistryABI:      ReservedBlockspaceRegistry(),
